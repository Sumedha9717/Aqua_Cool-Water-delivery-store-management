        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-2 my-auto d-none d-sm-none d-md-block d-lg-block">
                    <h5 class="brand-name">Aqua Cool</h5>
                </div>
                ...
                <div class="col-md-5 my-auto">
                    <ul class="nav justify-content-end">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <li><a class="dropdown-item" href="{{ url('/admin/dashboard') }}"><i class="fa fa-list"></i> Dashboard</a></li>
                            @else
                            <li><a class="dropdown-item" href="{{ url('/user/dashboard') }}"><i class="fa fa-list"></i> Dashboard</a></li>
                            @endif
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="{{ url('/contact_us') }}">Contact_Us</a>
                    </li>
