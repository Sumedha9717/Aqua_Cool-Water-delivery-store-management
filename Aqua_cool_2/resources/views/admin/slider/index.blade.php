                ...
                <table class="table table-bordered table-striped">
                    ...
                    <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="{{ url('admin/sliders/'.$slider->id.'/edit') }}" class="btn btn-success btn-outline-primary text-white">Edit</a>
                                    <a href="{{ url('admin/sliders/'.$slider->id.'/delete') }}"
                                        onclick="return confirm('Are You sure You want to Delete this Slider?.');"
                                        class="btn btn-danger btn-outline-info text-white">Delete</a>
                                </td>
                            </tr>
                            @endforeach
