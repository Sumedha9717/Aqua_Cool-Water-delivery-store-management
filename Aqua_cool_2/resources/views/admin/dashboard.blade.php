            ...
            <div class="row">
                ...
                <div class="row">
                    <div class="col-12 col-xl-8 mb-4 mb-xl-0">
                        @if(session('message'))
                         <h2 class="alert alert-success font-weight-bold">{{ session('message') }}</h2>
                        @endif
            ...
            <div class="row">
                ...
                <div class="row">
                    ...
                    <div class="card card-dark-blue">
                        ...
                        <p class="fs-30 mb-2">{{ $todayOrder }}</p>
                        {{-- <p>22.00% (30 days)</p> --}}
                        </div>
                    </div>
                    </div>
                    ...
                    <div class="card card-light-blue">
                        ...
                        <p class="fs-30 mb-2">{{ $totalAllUsers }}</p>
                        {{-- <p>2.00% (30 days)</p> --}}
                        </div>
                    </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-md-6 mb-4 mt-3 mb-lg-0 stretch-card transparent">
                    <div class="card card-light-blue">
                        <div class="card-body">
                    ...
                    <div class="col-md-6 stretch-card transparent mt-3">
                    <div class="card card-light-danger">
                        <div class="card-body">
